...
<div class="jumbotron text-center">
    <h1 class="display-3 text-white">Thank you for signing up</h1>
    <h3 class="display-6 text-white" style="margin-top: 1%;">A confirmation email has been sent for your account
        verification.</h3>
